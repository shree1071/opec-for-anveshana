...
function locale_default(locale3) {
  ...
  function newFormat(specifier, options) {
    ...
    var prefix = (options?.prefix !== void 0 ? options.prefix : "") + (symbol === "$" ? currencyPrefix : symbol === "#" && /[boxX]/.test(type) ? "0" + type.toLowerCase() : ""), suffix = (symbol === "$" ? currencySuffix : /[%p]/.test(type) ? percent : "") + (options?.suffix !== void 0 ? options.suffix : "");
...
//# sourceMappingURL=chunk-VZOY6AP4.js.map
