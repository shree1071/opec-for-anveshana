...
var h = (i3, s3, t2) => s3 in i3 ? e(i3, s3, {
  enumerable: true,
  configurable: true,
  writable: true,
  value: t2
}) : i3[s3] = t2;
var o = (i3, s3, t2) => h(i3, typeof s3 != "symbol" ? s3 + "" : s3, t2);
var _ = class {
  constructor() {
    o(this, "_locking");
    o(this, "_locks");
  ...
  lock() {
    this._locks += 1;
    let s3;
    const t2 = new Promise((l3) => s3 = () => {
      this._locks -= 1, l3();
    }), c2 = this._locking.then(() => s3);
...
var BinaryWriter = class {
  ...
  finish() {
    ...
    let len = 0;
    for (let i3 = 0; i3 < this.chunks.length; i3++) len += this.chunks[i3].length;
  ...
  return {
    ...
    get field() {
      if (!fi) {
        ...
        fi = runtime.util.newFieldList([i3]).list()[0];
      }
      return fi;
    },
    runtime
...
var decTable = [];
for (let i3 = 0; i3 < encTable.length; i3++) decTable[encTable[i3].charCodeAt(0)] = i3;
...
var protoBase64 = {
  ...
  dec(base64Str) {
    ...
    for (let i3 = 0; i3 < base64Str.length; i3++) {
      b2 = decTable[base64Str.charCodeAt(i3)];
      if (b2 === void 0) {
        switch (base64Str[i3]) {
          // @ts-ignore TS7029: Fallthrough case in switch
          case "=":
      ...
      for (const member of type.fields.byMember()) {
        ...
        switch (member.kind) {
            ...
            switch (member.V.kind) {
              ...
              case "enum":
                if (member.V.T === ScalarType.BYTES) {
                  for (const [k2, v2] of Object.entries(s3[localName])) {
          ...
          case "message":
            const mt = member.T;
            if (member.repeated) {
              t2[localName] = s3[localName].map((val2) => isMessage(val2, mt) ? val2 : new mt(val2));
            } else {
    ...
    equals(type, a, b2) {
      ...
      return type.fields.byMember().every((m2) => {
        ...
        if (m2.repeated) {
          ...
          switch (m2.kind) {
            case "message":
              return va.every((a2, i3) => m2.T.equals(a2, vb[i3]));
            case "scalar":
              return va.every((a2, i3) => scalarEquals(m2.T, a2, vb[i3]));
            case "enum":
              return va.every((a2, i3) => scalarEquals(ScalarType.INT32, a2, vb[i3]));
          }
...
function requireEvents() {
  ...
  EventEmitter.prototype.emit = function emit(type) {
    ...
    if (typeof handler === "function") {
      ...
      for (var i3 = 0; i3 < len; ++i3) ReflectApply(listeners[i3], this, args);
    }
    return true;
  };
  ...
  function arrayClone(arr, n2) {
    ...
    for (var i3 = 0; i3 < n2; ++i3) copy[i3] = arr[i3];
    return copy;
  }
...
function compareVersions(v1, v2) {
  ...
  for (let i3 = 0; i3 < k2; ++i3) {
    const p1 = parseInt(parts1[i3], 10);
    const p2 = parseInt(parts2[i3], 10);
    if (p1 > p2) return 1;
    if (p1 < p2) return -1;
    if (i3 === k2 - 1 && p1 === p2) return 0;
  }
  if (v1 === "" && v2 !== "") {
    return -1;
  } else if (v2 === "") {
...
function r(r3, e3, n2) {
  ...
  var a = null != (i3 = n2.isImmediate) && i3, u3 = null != (t2 = n2.callback) && t2, c2 = n2.maxWait, v2 = Date.now(), l3 = [];
  function f2() {
    if (void 0 !== c2) {
      var r4 = Date.now() - v2;
  ...
  var d2 = function() {
    ...
    return new Promise(function(i4, t3) {
      ...
      if (void 0 !== o3 && clearTimeout(o3), o3 = setTimeout(function() {
        if (o3 = void 0, v2 = Date.now(), !a) {
          var i5 = r3.apply(n3, e4);
          u3 && u3(i5), l3.forEach(function(r4) {
            return (0, r4.resolve)(i5);
          }), l3 = [];
        }
      }, f2()), c3) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let i3 = 0; i3 < participantOptions.count - 1; i3 += 1) {
        ...
        if (participantOptions.video) {
          const dummyVideo = createDummyVideoStreamTrack(160 * ((_d = participantOptions.aspectRatios[i3 % participantOptions.aspectRatios.length]) !== null && _d !== void 0 ? _d : 1), 160, false, true);
...
var r2 = class {
  ...
  constructor(e3, t2) {
    ...
    this.options = void 0, this.connection = void 0, this.lastInterruptTimestamp = 0, this.mode = "listening", this.status = "connecting", this.volume = 1, this.currentEventId = 1, this.lastFeedbackEventId = 0, this.canSendFeedback = false, this.endSessionWithDetails = async function(e4) {
      ...
      switch (e4.type) {
        ...
        case "client_tool_call":
          try {
            ...
            n2.onError(`Unexpected error in client tool call handling: ${t3 instanceof Error ? t3.message : String(t3)}`, { clientToolName: e4.client_tool_call.tool_name, toolCallId: e4.client_tool_call.tool_call_id });
          }
          return;
        case "audio":
      ...
      this.volume = e4;
    }, this.options = e3, this.connection = t2, this.options.onConnect && this.options.onConnect({ conversationId: t2.conversationId }), this.connection.onMessage(this.onMessage), this.connection.onDisconnect(this.endSessionWithDetails), this.connection.onModeChange((e4) => this.updateMode(e4)), this.updateStatus("connected");
  }
  endSession() {
  ...
  async handleClientToolCall(e3) {
    if (Object.prototype.hasOwnProperty.call(this.options.clientTools, e3.client_tool_call.tool_name)) try {
      var t2;
      const n2 = null != (t2 = await this.options.clientTools[e3.client_tool_call.tool_name](e3.client_tool_call.parameters)) ? t2 : "Client tool execution successful.", o3 = "object" == typeof n2 ? JSON.stringify(n2) : String(n2);
  ...
  handleErrorEvent(e3) {
    const t2 = e3.error_event.error_type, n2 = e3.error_event.message || e3.error_event.reason || "Unknown error";
    "max_duration_exceeded" !== t2 ? this.onError(`Server error: ${n2}`, { errorType: t2, code: e3.error_event.code, debugMessage: e3.error_event.debug_message, details: e3.error_event.details }) : this.endSessionWithDetails({ reason: "error", message: n2, context: new Event("max_duration_exceeded") });
  }
  onError(e3, t2) {
    console.error(e3, t2), this.options.onError && this.options.onError(e3, t2);
  }
  getId() {
...
var c = class {
  ...
  updateMode(e3) {
    var t2;
    null == (t2 = this.onModeChangeCallback) || t2.call(this, e3);
  }
  disconnect(e3) {
    var t2;
...
function l(e3) {
  ...
  return { format: t2, sampleRate: o3 };
}
var u = "0.13.0";
function d(e3) {
  return !!e3.type;
...
function p(e3) {
  var t2;
  const n2 = { type: h2 };
  var o3, a, s3, i3, r3, c2, l3, u3;
  return e3.overrides && (n2.conversation_config_override = { agent: { prompt: null == (o3 = e3.overrides.agent) ? void 0 : o3.prompt, first_message: null == (a = e3.overrides.agent) ? void 0 : a.firstMessage, language: null == (s3 = e3.overrides.agent) ? void 0 : s3.language }, tts: { voice_id: null == (i3 = e3.overrides.tts) ? void 0 : i3.voiceId, speed: null == (r3 = e3.overrides.tts) ? void 0 : r3.speed, stability: null == (c2 = e3.overrides.tts) ? void 0 : c2.stability, similarity_boost: null == (l3 = e3.overrides.tts) ? void 0 : l3.similarityBoost }, conversation: { text_only: null == (u3 = e3.overrides.conversation) ? void 0 : u3.textOnly } }), e3.customLlmExtraBody && (n2.custom_llm_extra_body = e3.customLlmExtraBody), e3.dynamicVariables && (n2.dynamic_variables = e3.dynamicVariables), e3.userId && (n2.user_id = e3.userId), null != (t2 = e3.overrides) && t2.client && (n2.source_info = { source: e3.overrides.client.source, version: e3.overrides.client.version }), n2;
}
var m = class extends Error {
  constructor(e3, t2) {
    super(e3), this.closeCode = void 0, this.closeReason = void 0, this.name = "SessionConnectionError", this.closeCode = null == t2 ? void 0 : t2.closeCode, this.closeReason = null == t2 ? void 0 : t2.closeReason;
  }
};
var v = class _v extends c {
  constructor(e3, t2, n2, o3) {
    super(), this.socket = void 0, this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.socket = e3, this.conversationId = t2, this.inputFormat = n2, this.outputFormat = o3, this.socket.addEventListener("error", (e4) => {
      ...
      try {
        ...
        if (!d(t3)) return void this.debug({ type: "invalid_event", message: "Received invalid socket event", data: e4.data });
        this.handleMessage(t3);
      } catch (t3) {
        this.debug({ type: "parsing_error", message: "Failed to parse socket message", error: t3 instanceof Error ? t3.message : String(t3), data: e4.data });
      }
    });
  }
  static async create(e3) {
    ...
    try {
      ...
      let i3;
      const r3 = (null == (o3 = e3.overrides) || null == (o3 = o3.client) ? void 0 : o3.version) || u, c2 = (null == (a = e3.overrides) || null == (a = a.client) ? void 0 : a.source) || "js_sdk";
      if (e3.signedUrl) {
        const t3 = e3.signedUrl.includes("?") ? "&" : "?";
        i3 = `${e3.signedUrl}${t3}source=${c2}&version=${r3}`;
      } else i3 = `${s4}/v1/convai/conversation?agent_id=${e3.agentId}&source=${c2}&version=${r3}`;
      const h3 = ["convai"];
      e3.authorization && h3.push(`bearer.${e3.authorization}`), t2 = new WebSocket(i3, h3);
      const g2 = await new Promise((n3, o4) => {
        t2.addEventListener("open", () => {
          var n4;
          const o5 = p(e3);
          null == (n4 = t2) || n4.send(JSON.stringify(o5));
        }, { once: true }), t2.addEventListener("error", (e4) => {
          setTimeout(() => o4(new m("The connection was closed due to a socket error.")), 0);
        }), t2.addEventListener("close", (e4) => {
        ...
        }), t2.addEventListener("message", (e4) => {
          const t3 = JSON.parse(e4.data);
          d(t3) && ("conversation_initiation_metadata" === t3.type ? n3(t3.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
        }, { once: true });
      }), { conversation_id: f2, agent_output_audio_format: _3, user_input_audio_format: w2 } = g2, b2 = l(null != w2 ? w2 : "pcm_16000"), S2 = l(_3);
      return new _v(t2, f2, b2, S2);
    } catch (e4) {
      var s3;
      throw null == (s3 = t2) || s3.close(), e4;
    }
  }
  close() {
...
function f(e3) {
  const t2 = window.atob(e3), n2 = t2.length, o3 = new Uint8Array(n2);
  for (let e4 = 0; e4 < n2; e4++) o3[e4] = t2.charCodeAt(e4);
  return o3.buffer;
}
...
function w(e3, t2) {
  return async (n2, o3) => {
    const a = _2.get(e3);
    if (a) return n2.addModule(a);
    if (o3) try {
      return await n2.addModule(o3), void _2.set(e3, o3);
    } catch (t3) {
      throw new Error(`Failed to load the ${e3} worklet module from path: ${o3}. Error: ${t3}`);
    }
    const s3 = new Blob([t2], { type: "application/javascript" }), i3 = URL.createObjectURL(s3);
    try {
      return await n2.addModule(i3), void _2.set(e3, i3);
    } catch (e4) {
      URL.revokeObjectURL(i3);
    }
    try {
      const o4 = `data:application/javascript;base64,${btoa(t2)}`;
...
var S = class _S extends c {
  constructor(e3, t2, n2, o3, a = {}) {
    super(a), this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.room = void 0, this.isConnected = false, this.audioEventId = 1, this.audioCaptureContext = null, this.audioElements = [], this.outputDeviceId = null, this.outputAnalyser = null, this.outputFrequencyData = null, this.room = e3, this.conversationId = t2, this.inputFormat = n2, this.outputFormat = o3, this.setupRoomEventListeners();
  }
  static async create(n2) {
    ...
    if ("conversationToken" in n2 && n2.conversationToken) o3 = n2.conversationToken;
      ...
      try {
        var a, s3, i3;
        const e3 = (null == (a = n2.overrides) || null == (a = a.client) ? void 0 : a.version) || u, t2 = (null == (s3 = n2.overrides) || null == (s3 = s3.client) ? void 0 : s3.source) || "js_sdk", c3 = `${r3 = null != (i3 = n2.origin) ? i3 : "https://api.elevenlabs.io", r3.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n2.agentId}&source=${t2}&version=${e3}`, l3 = await fetch(c3);
        if (!l3.ok) throw new Error(`ElevenLabs API returned ${l3.status} ${l3.statusText}`);
        if (o3 = (await l3.json()).token, !o3) throw new Error("No conversation token received from API");
      } catch (e3) {
    ...
    const c2 = new Room();
    try {
      const e3 = `room_${Date.now()}`, a2 = l("pcm_48000"), s4 = l("pcm_48000"), i4 = new _S(c2, e3, a2, s4, n2), r4 = n2.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d2;
      await c2.connect(r4, o3), await new Promise((e4) => {
        if (i4.isConnected) e4();
        else {
          const n3 = () => {
            c2.off(RoomEvent.Connected, n3), e4();
          };
          c2.on(RoomEvent.Connected, n3);
        }
      }), c2.name && (i4.conversationId = (null == (d2 = c2.name.match(/(conv_[a-zA-Z0-9]+)/)) ? void 0 : d2[0]) || c2.name), n2.textOnly || await c2.localParticipant.setMicrophoneEnabled(true);
      const u3 = p(n2);
      return i4.debug({ type: h2, message: u3 }), await i4.sendMessage(u3), i4;
    } catch (e3) {
      throw await c2.disconnect(), e3;
    }
  }
  setupRoomEventListeners() {
    ...
    this.room.on(RoomEvent.Connected, async function() {
      ...
      try {
        ...
        d(t3) ? this.handleMessage(t3) : console.warn("Invalid socket event received:", t3);
      } catch (t3) {
        console.warn("Failed to parse incoming data message:", t3), console.warn("Raw payload:", new TextDecoder().decode(e4));
      }
    }), this.room.on(RoomEvent.TrackSubscribed, async function(t2, n2, a) {
      if (t2.kind === Track.Kind.Audio && a.identity.includes("agent")) {
        const n3 = t2, o3 = n3.attach();
    ...
    }), this.room.on(RoomEvent.ActiveSpeakersChanged, async function(t2) {
      e3.updateMode(t2.length > 0 && t2[0].identity.startsWith("agent") ? "speaking" : "listening");
    }), this.room.on(RoomEvent.ParticipantDisconnected, (e4) => {
      var t2;
      null != (t2 = e4.identity) && t2.startsWith("agent") && this.disconnect({ reason: "agent", context: new CloseEvent("close", { reason: "agent disconnected" }) });
    });
  }
  close() {
    if (this.isConnected) {
  ...
  async setMicMuted(e3) {
    ...
    const t2 = this.room.localParticipant.getTrackPublication(Track.Source.Microphone);
    if (null != t2 && t2.track) try {
      e3 ? await t2.track.mute() : await t2.track.unmute();
    } catch (t3) {
  ...
  async setupAudioCapture(e3) {
    try {
      ...
      this.audioCaptureContext = t2, this.outputAnalyser = t2.createAnalyser(), this.outputAnalyser.fftSize = 2048, this.outputAnalyser.smoothingTimeConstant = 0.8;
      const n2 = new MediaStream([e3.mediaStreamTrack]), o3 = t2.createMediaStreamSource(n2);
      o3.connect(this.outputAnalyser), await b(t2.audioWorklet);
      const a = new AudioWorkletNode(t2, "rawAudioProcessor");
      this.outputAnalyser.connect(a), a.port.postMessage({ type: "setFormat", format: this.outputFormat.format, sampleRate: this.outputFormat.sampleRate }), a.port.onmessage = (e4) => {
        const [t3, n3] = e4.data;
        if (n3 > 0.01) {
          const e5 = g(t3.buffer), n4 = this.audioEventId++;
  ...
  async setAudioOutputDevice(e3) {
    ...
    const t2 = this.audioElements.map(async function(t3) {
      try {
        await t3.setSinkId(e3);
      } catch (e4) {
        throw console.error("Failed to set sink ID for audio element:", e4), e4;
      }
    });
    await Promise.all(t2), this.outputDeviceId = e3;
  }
  async setAudioInputDevice(e3) {
    ...
    try {
      const t2 = this.room.localParticipant.getTrackPublication(Track.Source.Microphone);
      null != t2 && t2.track && (await t2.track.stop(), await this.room.localParticipant.unpublishTrack(t2.track));
...
async function E(e3 = { default: 0, android: 3e3 }) {
  ...
  if (/android/i.test(navigator.userAgent)) t2 = null != (n2 = e3.android) ? n2 : t2;
    ...
    var o3;
    t2 = null != (o3 = e3.ios) ? o3 : t2;
  }
  t2 > 0 && await new Promise((e4) => setTimeout(e4, t2));
}
var C = class _C extends r2 {
  static async startSession(e3) {
    const t2 = r2.getFullOptions(e3);
    t2.onStatusChange && t2.onStatusChange({ status: "connecting" }), t2.onCanSendFeedbackChange && t2.onCanSendFeedbackChange({ canSendFeedback: false }), t2.onModeChange && t2.onModeChange({ mode: "listening" }), t2.onCanSendFeedbackChange && t2.onCanSendFeedbackChange({ canSendFeedback: false });
    let n2 = null;
    try {
      return await E(t2.connectionDelay), n2 = await y(e3), new _C(t2, n2);
    } catch (e4) {
      var o3;
      throw t2.onStatusChange && t2.onStatusChange({ status: "disconnected" }), null == (o3 = n2) || o3.close(), e4;
    }
  }
};
var R = { echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } };
var M = class _M {
  static async create({ sampleRate: e3, format: t2, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: a, libsampleratePath: i3 }) {
    let r3 = null, c2 = null;
    try {
      const l4 = s({ sampleRate: { ideal: e3 } }, R);
      if (k() && n2) {
      ...
      o3 && (l4.deviceId = _M.getDeviceIdConstraint(o3));
      const u4 = navigator.mediaDevices.getSupportedConstraints().sampleRate;
      r3 = new window.AudioContext(u4 ? { sampleRate: e3 } : {});
      const d2 = r3.createAnalyser();
      if (!u4) {
        const e4 = i3 || "https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js";
        await r3.audioWorklet.addModule(e4);
      }
      await b(r3.audioWorklet, null == a ? void 0 : a.rawAudioProcessor);
      const h3 = s({ voiceIsolation: true }, l4);
      ...
      return m2.port.postMessage({ type: "setFormat", format: t2, sampleRate: e3 }), p2.connect(d2), d2.connect(m2), await r3.resume(), new _M(r3, d2, m2, c2, p2);
    } catch (e4) {
      var l3, u3;
      throw null == (l3 = c2) || l3.getTracks().forEach((e5) => {
        e5.stop();
      }), null == (u3 = r3) || u3.close(), e4;
    }
  }
  ...
  constructor(e3, t2, n2, o3, a) {
    this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.mediaStreamSource = void 0, this.context = e3, this.analyser = t2, this.worklet = n2, this.inputStream = o3, this.mediaStreamSource = a;
  }
  async close() {
  ...
  async setInputDevice(e3) {
    try {
      const t2 = s({}, R);
      e3 && (t2.deviceId = _M.getDeviceIdConstraint(e3));
      const n2 = s({ voiceIsolation: true }, t2), o3 = await navigator.mediaDevices.getUserMedia({ audio: n2 });
...
var I = class _I {
  static async create({ sampleRate: e3, format: t2, outputDeviceId: n2, workletPaths: o3 }) {
    let a = null, s3 = null;
    try {
      a = new AudioContext({ sampleRate: e3 });
      const i4 = a.createAnalyser(), r4 = a.createGain();
      ...
      s3.srcObject = c2.stream, r4.connect(i4), i4.connect(c2), await A(a.audioWorklet, null == o3 ? void 0 : o3.audioConcatProcessor);
      const l3 = new AudioWorkletNode(a, "audioConcatProcessor");
      return l3.port.postMessage({ type: "setFormat", format: t2 }), l3.connect(r4), await a.resume(), n2 && s3.setSinkId && await s3.setSinkId(n2), new _I(a, i4, r4, l3, s3);
    } catch (e4) {
      var i3, r3;
      throw null != (i3 = s3) && i3.parentNode && s3.parentNode.removeChild(s3), null == (r3 = s3) || r3.pause(), a && "closed" !== a.state && await a.close(), e4;
    }
  }
  constructor(e3, t2, n2, o3, a) {
    this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.audioElement = void 0, this.context = e3, this.analyser = t2, this.gain = n2, this.worklet = o3, this.audioElement = a;
  }
...
var D = class _D extends r2 {
  ...
  static async startSession(e3) {
    ...
    let o3 = null, a = null, i3 = null, c2 = null, l3 = null;
    (null == (t2 = e3.useWakeLock) || t2) && (l3 = await _D.requestWakeLock());
    try {
      var u3;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await E(n2.connectionDelay), a = await y(e3), [o3, i3] = await Promise.all([M.create(s({}, a.inputFormat, { preferHeadphonesForIosDevices: e3.preferHeadphonesForIosDevices, inputDeviceId: e3.inputDeviceId, workletPaths: e3.workletPaths, libsampleratePath: e3.libsampleratePath })), I.create(s({}, a.outputFormat, { outputDeviceId: e3.outputDeviceId, workletPaths: e3.workletPaths }))]), null == (u3 = c2) || u3.getTracks().forEach((e4) => {
        e4.stop();
      }), c2 = null, new _D(n2, a, o3, i3, l3);
    } catch (e4) {
      var d2, h3, p2, m2;
      n2.onStatusChange && n2.onStatusChange({ status: "disconnected" }), null == (d2 = c2) || d2.getTracks().forEach((e5) => {
        e5.stop();
      }), null == (h3 = a) || h3.close(), await (null == (p2 = o3) ? void 0 : p2.close()), await (null == (m2 = i3) ? void 0 : m2.close());
      try {
        var v2;
  ...
  constructor(e3, t2, n2, o3, a) {
    super(e3, t2), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.visibilityChangeHandler = null, this.onInputWorkletMessage = (e4) => {
      ...
      const t3 = Number.isFinite(e4) ? Math.min(1, Math.max(0, e4)) : 1;
      this.volume = t3, this.connection instanceof S ? this.connection.setAudioVolume(t3) : this.output.gain.gain.value = t3;
    }, this.input = n2, this.output = o3, this.wakeLock = a, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage, a && (this.visibilityChangeHandler = () => {
      var e4;
  ...
  handleAudio(e3) {
    var t2, n2;
    super.handleAudio(e3), e3.audio_event.alignment && this.options.onAudioAlignment && this.options.onAudioAlignment(e3.audio_event.alignment), this.lastInterruptTimestamp <= e3.audio_event.event_id && (e3.audio_event.audio_base_64 && (null == (t2 = (n2 = this.options).onAudio) || t2.call(n2, e3.audio_event.audio_base_64), this.connection instanceof S || this.addAudioBase64Chunk(e3.audio_event.audio_base_64)), this.currentEventId = e3.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e3) {
  ...
  async changeInputDevice({ sampleRate: e3, format: t2, preferHeadphonesForIosDevices: n2, inputDeviceId: o3 }) {
    try {
      ...
      const a = await M.create({ sampleRate: null != e3 ? e3 : this.connection.inputFormat.sampleRate, format: null != t2 ? t2 : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath });
  ...
  async changeOutputDevice({ sampleRate: e3, format: t2, outputDeviceId: n2 }) {
    try {
      if (this.connection instanceof v) try {
      ...
      const o3 = await I.create({ sampleRate: null != e3 ? e3 : this.connection.outputFormat.sampleRate, format: null != t2 ? t2 : this.connection.outputFormat.format, outputDeviceId: n2, workletPaths: this.options.workletPaths });
...
function T(e3, t2, n2 = "https://api.elevenlabs.io") {
  const o3 = {};
  return "boolean" == typeof t2 ? o3.feedback = t2 ? "like" : "dislike" : (o3.rating = t2.rating, o3.comment = t2.comment), fetch(`${n2}/v1/convai/conversations/${e3}/feedback`, { method: "POST", body: JSON.stringify(o3), headers: { "Content-Type": "application/json" } });
}
var F = class {
  constructor() {
  ...
  setWebSocket(e3) {
    this.websocket = e3, this.websocket.readyState === WebSocket.OPEN ? this.eventEmitter.emit(P.OPEN) : this.websocket.addEventListener("open", () => {
      ...
      try {
        ...
        switch (t2.message_type) {
          case "session_started":
            this.eventEmitter.emit(P.SESSION_STARTED, t2);
            break;
          case "partial_transcript":
            this.eventEmitter.emit(P.PARTIAL_TRANSCRIPT, t2);
            break;
          case "committed_transcript":
            this.eventEmitter.emit(P.COMMITTED_TRANSCRIPT, t2);
            break;
          case "committed_transcript_with_timestamps":
            this.eventEmitter.emit(P.COMMITTED_TRANSCRIPT_WITH_TIMESTAMPS, t2);
            break;
          case "auth_error":
            this.eventEmitter.emit(P.AUTH_ERROR, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "quota_exceeded":
            this.eventEmitter.emit(P.QUOTA_EXCEEDED, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "commit_throttled":
            this.eventEmitter.emit(P.COMMIT_THROTTLED, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "transcriber_error":
            this.eventEmitter.emit(P.TRANSCRIBER_ERROR, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "unaccepted_terms":
            this.eventEmitter.emit(P.UNACCEPTED_TERMS, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "rate_limited":
            this.eventEmitter.emit(P.RATE_LIMITED, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "input_error":
            this.eventEmitter.emit(P.INPUT_ERROR, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "queue_overflow":
            this.eventEmitter.emit(P.QUEUE_OVERFLOW, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "resource_exhausted":
            this.eventEmitter.emit(P.RESOURCE_EXHAUSTED, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "session_time_limit_exceeded":
            this.eventEmitter.emit(P.SESSION_TIME_LIMIT_EXCEEDED, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "chunk_size_exceeded":
            this.eventEmitter.emit(P.CHUNK_SIZE_EXCEEDED, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "insufficient_audio_activity":
            this.eventEmitter.emit(P.INSUFFICIENT_AUDIO_ACTIVITY, t2), this.eventEmitter.emit(P.ERROR, t2);
            break;
          case "error":
            this.eventEmitter.emit(P.ERROR, t2);
            break;
          default:
            console.warn("Unknown message type:", t2);
        }
      } catch (t2) {
        console.error("Failed to parse WebSocket message:", t2, e4.data), this.eventEmitter.emit(P.ERROR, new Error(`Failed to parse message: ${t2}`));
      }
      ...
      if (console.log(`WebSocket closed: code=${e4.code}, reason="${e4.reason}", wasClean=${e4.wasClean}`), !e4.wasClean || 1e3 !== e4.code && 1005 !== e4.code) {
        const t2 = `WebSocket closed unexpectedly: ${e4.code} - ${e4.reason || "No reason provided"}`;
        console.error(t2), this.eventEmitter.emit(P.ERROR, new Error(t2));
      }
      this.eventEmitter.emit(P.CLOSE, e4);
    });
  }
  on(e3, t2) {
    this.eventEmitter.on(e3, t2);
  }
  off(e3, t2) {
    this.eventEmitter.off(e3, t2);
  }
  send(e3) {
    var t2, n2;
    if (!this.websocket || this.websocket.readyState !== WebSocket.OPEN) throw new Error("WebSocket is not connected");
    const o3 = { message_type: "input_audio_chunk", audio_base_64: e3.audioBase64, commit: null != (t2 = e3.commit) && t2, sample_rate: null != (n2 = e3.sampleRate) ? n2 : this.currentSampleRate, previous_text: e3.previousText };
...
var N = class _N {
  ...
  static buildWebSocketUri(e3) {
    const t2 = _N.getWebSocketUri(e3.baseUri), n2 = new URLSearchParams();
  ...
  static connect(e3) {
    ...
    const t2 = new x("microphone" in e3 && e3.microphone ? 16e3 : e3.sampleRate), n2 = _N.buildWebSocketUri(e3), o3 = new WebSocket(n2);
    return "microphone" in e3 && e3.microphone && o3.addEventListener("open", () => {
      _N.streamFromMicrophone(e3, t2);
    }), t2.setWebSocket(o3), t2;
  }
  static async streamFromMicrophone(e3, t2) {
    const n2 = 16e3;
    try {
      var o3, a, s3, i3, r3, c2, l3, u3, d2, h3;
      const p2 = await navigator.mediaDevices.getUserMedia({ audio: { deviceId: null == (o3 = e3.microphone) ? void 0 : o3.deviceId, echoCancellation: null == (a = null == (s3 = e3.microphone) ? void 0 : s3.echoCancellation) || a, noiseSuppression: null == (i3 = null == (r3 = e3.microphone) ? void 0 : r3.noiseSuppression) || i3, autoGainControl: null == (c2 = null == (l3 = e3.microphone) ? void 0 : l3.autoGainControl) || c2, channelCount: null != (u3 = null == (d2 = e3.microphone) ? void 0 : d2.channelCount) ? u3 : 1, sampleRate: { ideal: n2 } } }), m2 = null == (h3 = p2.getAudioTracks()[0]) ? void 0 : h3.getSettings(), v2 = null == m2 ? void 0 : m2.sampleRate, g2 = new AudioContext(v2 ? { sampleRate: v2 } : {});
      ...
      g2.sampleRate !== n2 && _3.port.postMessage({ type: "configure", inputSampleRate: g2.sampleRate, outputSampleRate: n2 }), _3.port.onmessage = (e4) => {
        ...
        let a2 = "";
        for (let e5 = 0; e5 < o4.length; e5++) a2 += String.fromCharCode(o4[e5]);
        const s4 = btoa(a2);
        t2.send({ audioBase64: s4 });
      }, f2.connect(_3), "suspended" === g2.state && await g2.resume(), t2._audioCleanup = () => {
...
function u2() {
  return u2 = Object.assign ? Object.assign.bind() : function(e3) {
    for (var n2 = 1; n2 < arguments.length; n2++) {
      var l3 = arguments[n2];
      for (var r3 in l3) ({}).hasOwnProperty.call(l3, r3) && (e3[r3] = l3[r3]);
    }
    return e3;
...
function o2(e3 = "us") {
  switch (e3) {
    ...
    default:
      return console.warn(
        `[ConversationalAI] Invalid server-location: ${e3}. Defaulting to "us"`
      ), "us";
  }
}
function i2(e3) {
...
function s2(s3 = {}) {
  const { micMuted: a, volume: c2, serverLocation: d2 } = s3, v2 = (function(e3, n2) {
    if (null == e3) return {};
    var l3 = {};
    for (var r3 in e3)
    ...
    return l3;
  })(s3, t), g2 = (0, import_react.useRef)(null), p2 = (0, import_react.useRef)(null), [m2, y2] = (0, import_react.useState)("disconnected"), [f2, b2] = (0, import_react.useState)(false), [C2, M2] = (0, import_react.useState)("listening");
  return (0, import_react.useEffect)(() => {
    var e3;
    void 0 !== a && (null == g2 || null == (e3 = g2.current) || e3.setMicMuted(a));
  }, [a]), (0, import_react.useEffect)(() => {
    var e3;
    void 0 !== c2 && (null == g2 || null == (e3 = g2.current) || e3.setVolume({ volume: c2 }));
  }, [c2]), (0, import_react.useEffect)(
    () => () => {
      var e3;
      null == (e3 = g2.current) || e3.endSession();
    },
    []
  ), {
    startSession: async (e3) => {
      var n2;
      if (null != (n2 = g2.current) && n2.isOpen()) return g2.current.getId();
      if (p2.current) return (await p2.current).getId();
      try {
        var l3, t2, s4, m3, f3, C3, w2, D2, I2, O2;
        const n3 = i2(o2((null == e3 ? void 0 : e3.serverLocation) || d2));
        return p2.current = W.startSession(
          u2({}, null != v2 ? v2 : {}, null != e3 ? e3 : {}, {
            origin: n3,
            overrides: u2(
              {},
              null != (l3 = null == v2 ? void 0 : v2.overrides) ? l3 : {},
              null != (t2 = null == e3 ? void 0 : e3.overrides) ? t2 : {},
              {
                client: u2(
                  {},
                  null != (s4 = null == v2 || null == (m3 = v2.overrides) ? void 0 : m3.client) ? s4 : {},
                  null != (f3 = null == e3 || null == (C3 = e3.overrides) ? void 0 : C3.client) ? f3 : {},
                  {
                    source: (null == e3 || null == (w2 = e3.overrides) || null == (w2 = w2.client) ? void 0 : w2.source) || (null == v2 || null == (D2 = v2.overrides) || null == (D2 = D2.client) ? void 0 : D2.source) || "react_sdk",
                    version: (null == e3 || null == (I2 = e3.overrides) || null == (I2 = I2.client) ? void 0 : I2.version) || (null == v2 || null == (O2 = v2.overrides) || null == (O2 = O2.client) ? void 0 : O2.version) || "0.4.3"
                  }
                )
              }
            ),
            onConnect: (null == e3 ? void 0 : e3.onConnect) || (null == v2 ? void 0 : v2.onConnect),
            onDisconnect: (null == e3 ? void 0 : e3.onDisconnect) || (null == v2 ? void 0 : v2.onDisconnect),
            onError: (null == e3 ? void 0 : e3.onError) || (null == v2 ? void 0 : v2.onError),
            onMessage: (null == e3 ? void 0 : e3.onMessage) || (null == v2 ? void 0 : v2.onMessage),
            onAudio: (null == e3 ? void 0 : e3.onAudio) || (null == v2 ? void 0 : v2.onAudio),
            onDebug: (null == e3 ? void 0 : e3.onDebug) || (null == v2 ? void 0 : v2.onDebug),
            onUnhandledClientToolCall: (null == e3 ? void 0 : e3.onUnhandledClientToolCall) || (null == v2 ? void 0 : v2.onUnhandledClientToolCall),
            onModeChange: ({ mode: e4 }) => {
              M2(e4);
            },
        ...
        ), g2.current = await p2.current, void 0 !== a && g2.current.setMicMuted(a), void 0 !== c2 && g2.current.setVolume({ volume: c2 }), g2.current.getId();
      } finally {
        p2.current = null;
      }
    },
    endSession: async () => {
      const e3 = g2.current;
      g2.current = null, await (null == e3 ? void 0 : e3.endSession());
    },
    setVolume: ({ volume: e3 }) => {
      var n2;
      null == (n2 = g2.current) || n2.setVolume({ volume: e3 });
    },
    getInputByteFrequencyData: () => {
      var e3;
      return null == (e3 = g2.current) ? void 0 : e3.getInputByteFrequencyData();
    },
    getOutputByteFrequencyData: () => {
      var e3;
      return null == (e3 = g2.current) ? void 0 : e3.getOutputByteFrequencyData();
    },
    getInputVolume: () => {
      var e3, n2;
      return null != (e3 = null == (n2 = g2.current) ? void 0 : n2.getInputVolume()) ? e3 : 0;
    },
    getOutputVolume: () => {
      var e3, n2;
      return null != (e3 = null == (n2 = g2.current) ? void 0 : n2.getOutputVolume()) ? e3 : 0;
    },
    sendFeedback: (e3) => {
      var n2;
      null == (n2 = g2.current) || n2.sendFeedback(e3);
    },
    getId: () => {
      var e3;
      return null == (e3 = g2.current) ? void 0 : e3.getId();
    },
    sendContextualUpdate: (e3) => {
      var n2;
      null == (n2 = g2.current) || n2.sendContextualUpdate(e3);
    },
    sendUserMessage: (e3) => {
      var n2;
      null == (n2 = g2.current) || n2.sendUserMessage(e3);
    },
    sendUserActivity: () => {
      var e3;
      null == (e3 = g2.current) || e3.sendUserActivity();
    },
    sendMCPToolApprovalResult: (e3, n2) => {
      var l3;
      null == (l3 = g2.current) || l3.sendMCPToolApprovalResult(e3, n2);
    },
    status: m2,
    canSendFeedback: f2,
    micMuted: a,
    isSpeaking: "speaking" === C2
  };
}
export {
  i2 as getOriginForLocation,
  o2 as parseLocation,
  T as postOverallFeedback,
  s2 as useConversation
};
